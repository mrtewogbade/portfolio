...
//           <article
//             key={project._id}
//             className="overflow-hidden dark:border-zinc-600 rounded-lg border-gray-100 bg-white shadow-lg dark:bg-black dark:shadow-gray-700 shadow-teal-100 "
//           >
//             <div className="h-56 w-full relative">
//               <Image
//                 fill
//                 src={project.imageUrl}
//                 alt="Image of the projects"
...
//               <p className="line-clamp-3mt-2 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
//                 {project.overview}
//               </p>
